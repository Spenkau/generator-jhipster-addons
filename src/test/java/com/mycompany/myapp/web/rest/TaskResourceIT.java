...
class TaskResourceIT {
    ...
    public static Task createEntity(EntityManager em) {
        Task task = new Task().name(DEFAULT_NAME).categoryId(DEFAULT_CATEGORY_ID);
        return task;
    }
    ...
    public static Task createUpdatedEntity(EntityManager em) {
        Task task = new Task().name(UPDATED_NAME).categoryId(UPDATED_CATEGORY_ID);
        return task;
    }
    ...
    void createTask() throws Exception {
        ...
        assertThat(testTask.getCategoryId()).isEqualTo(DEFAULT_CATEGORY_ID);
    }
    ...
    void putExistingTask() throws Exception {
        ...
        updatedTask.name(UPDATED_NAME).categoryId(UPDATED_CATEGORY_ID);
        ...
        assertThat(testTask.getCategoryId()).isEqualTo(UPDATED_CATEGORY_ID);
    }
    ...
    void partialUpdateTaskWithPatch() throws Exception {
        ...
        partialUpdatedTask.categoryId(UPDATED_CATEGORY_ID);
    ...
    void fullUpdateTaskWithPatch() throws Exception {
        ...
        partialUpdatedTask.name(UPDATED_NAME).categoryId(UPDATED_CATEGORY_ID);
